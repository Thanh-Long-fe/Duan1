    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Sản phẩm bị ẩn</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sản phẩm ẩn</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <?php foreach($product as $sp) :?>
                                    ...
                                    <tr>
                                                ...
                                                phẩm</a></span><span><a href="index.php?act=view_sp&id=<?=$sp['id']?>"
                                                class="btn btn-danger btn-sm" onclick="return confirm('Có muốn hiện không ?')">Hiện sản phẩm</a></span></td>
                                            </tr>
                                    <?php endforeach?>    
