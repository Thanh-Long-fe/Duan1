                        ...
                        <div class="login-accordion" id="LoginAccordion">
                            <div class="card">
                                <h3>
                                    ...
                                    Returning customer?
                                    <a href="#/" data-bs-toggle="collapse" data-bs-target="#loginaccordion">Click here
                                        to login</a>
                                </h3>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="check_payments4">
                                            <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemFour"
                                                aria-controls="itemTwo" aria-expanded="false">PayPal Express Checkout
                                                <img src="assets/img/photos/paypal2.webp" width="40" height="26"
